...
parser.add_argument('--output_dir', type=str, default="/jet/home/dhanotiy/tmp_ondemand_ocean_cis230079p_symlink/shared/CapStone-VeyTel-2024/datasets/output")
parser.add_argument('--model', type=str, default="resnet101")
parser.add_argument('--train_img_dir', type=str, default="/jet/home/dhanotiy/tmp_ondemand_ocean_cis230079p_symlink/shared/CapStone-VeyTel-2024/datasets/data-clean/train/")
parser.add_argument('--train_csv_file', type=str, default="/jet/home/dhanotiy/tmp_ondemand_ocean_cis230079p_symlink/shared/CapStone-VeyTel-2024/datasets/train_labels.csv")
parser.add_argument('--test_img_dir', type=str, default="/jet/home/dhanotiy/tmp_ondemand_ocean_cis230079p_symlink/shared/CapStone-VeyTel-2024/datasets/data-clean/train/")
parser.add_argument('--test_csv_file', type=str, default="/jet/home/dhanotiy/tmp_ondemand_ocean_cis230079p_symlink/shared/CapStone-VeyTel-2024/datasets/test_labels.csv")
...
parser.add_argument('--threads', type=int, default=60, help='')
...
if "custom" in cfg.dataset:
    dataset = xrv.datasets.PneumoniaXRayDataset(
        imgpath=cfg.train_img_dir,
        csvpath=cfg.train_csv_file,
        transform=transforms, data_aug=data_aug)
    datas.append(dataset)
...
# Load datasets
train_dataset = xrv.datasets.PneumoniaXRayDataset(imgpath=cfg.train_img_dir, csvpath=cfg.train_csv_file, transform=transforms)
test_dataset = xrv.datasets.PneumoniaXRayDataset(imgpath=cfg.test_img_dir, csvpath=cfg.test_csv_file, transform=transforms)
